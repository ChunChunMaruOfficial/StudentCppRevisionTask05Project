...
int task01(int hour1, int minute1, int second1, int hour2, int minute2, int second2) {
	int all_sec_fday = (hour1 * 3600) + (minute1 * 60) + second1;
	int all_sec_sday = (hour2 * 3600) + (minute2 * 60) + second2;


	return	hour1 < 0 || minute1 < 0 || second1 < 0 || hour2 < 0 || minute2 < 0 || second2  < 0 ? -1 : all_sec_fday > all_sec_sday ? all_sec_fday - all_sec_sday : all_sec_sday - all_sec_fday;
